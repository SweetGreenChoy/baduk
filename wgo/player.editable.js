(function (WGo) {
  ...
  WGo.Player.Editable.prototype.set = function (set) {
    if (!this.editMode && set) {
      ...
      this.player.kifuReader = new WGo.KifuReader(
      ...
      this.originalReader.change = pos_diff(
        this.player.kifuReader.getPosition(),
    ...
    WGo.BasicPlayer.component.Control.menu.push({
      ...
      args: {
        ...
        click: function (player) {
          this._editable =
            this._editable || new WGo.Player.Editable(player, player.board);
